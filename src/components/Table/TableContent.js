...
import { editContent, deleteContent, toggleContent, activateContent } from  "../../actions/content";
...
function CustomTable({ ...props }) {
  ...
  const handleClick = (num) => {
     props.editContent(num)
  }
  const handleDelete = (num) => {
    props.deleteContent(num)
  }
  const handleToggle= (num) => {
    props.activateContent(num)
  }
...
export default connect(mapStateToProps, {editContent, deleteContent, toggleContent, activateContent})(withStyles(tableStyle)(CustomTable));