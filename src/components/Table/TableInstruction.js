...
import { editInstruction, deleteInstruction, toggleInstruction, activateInstruction } from  "../../actions/instruction";
...
export default connect(mapStateToProps, {editInstruction, deleteInstruction, toggleInstruction, activateInstruction})(withStyles(tableStyle)(CustomTable));