...
import { toggleForm, hideActions } from '../../actions/mockscore';
...
class HeaderLinks extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      <NavLink to={`/admin/Theme/${this.props.id}`}>
        <Button
          color={"white"}
          justIcon={window.innerWidth > 959}
          simple={!(window.innerWidth > 959)}
        ...
        >
          <Backward color={"white"} className={classes.icons} />
          <Hidden mdUp implementation="css">
